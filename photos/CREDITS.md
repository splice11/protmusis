...
Attribution reconstructed from filename patterns, watermarks and EXIF data
of the uploaded files. Items marked **to confirm** could not be fully
traced offline — please verify before any use outside the internal quiz.

| File | Shows | Slide | Source / attribution |
|---|---|---|---|
| `pheasant_island.jpg` | Pheasant Island in the Bidasoa | R1 A1 | Wikimedia Commons, "Isla de los Faisanes (edited)" |
| `berlaymont_flag_1986.jpg` | First raising of the European flag, Berlaymont, May 1986 | R1 A2 | © European Communities, 1986 — EC Audiovisual Service (file circulated via social media) |
| `nobel_peace_prize_2012.jpg` | Van Rompuy, Barroso and Schulz receiving the Nobel Peace Prize, Oslo, 10 Dec 2012 | R1 A3 | Reuters (watermarked); file served via RFE/RL |
| `euro_500_note.jpg` | €500 banknotes | R1 A4 | Bloomberg News via The Wall Street Journal (April 2016 asset) — **to confirm** |
| `jeans_rivets.jpg` | Copper rivets on jeans ("SF Cal. 1873") | R1 A6 | Untraced (MD5-named file, widely circulated) — **to confirm** |
| `lt_united_eurovision_2006.jpg` | LT United on the Eurovision 2006 stage | R2 A1 | EBU / eurovision.tv (broadcast still, YouTube thumbnail) |
| `lena_valaitis_1981.jpg` | Lena Valaitis, Eurovision 1981 | R2 A1 | EBU / eurovision.tv (CDN asset) |
| `vitkauskas_everest_1995.jpg` | Vladas Vitkauskas on the Everest summit, 1995 | R2 A2 | V. Vitkauskas archive, via a Lithuanian WordPress site — **to confirm** |
| `baltic_amber.jpg` | Baltic amber against the sun | R2 A2 | Untraced (news/stock photo) — **to confirm** |
| `interwar_lithuania_1930s.jpg` | Street procession, interwar Lithuania | R2 A3 | 1930s archive photograph, source untraced (served via a 2022 news CMS) — **to confirm** |
| `fern_fiddleheads.jpg` | Ostrich-fern fiddleheads | R2 A4 | Wikimedia Commons, "Matteuccia struthiopteris fiddleheads" |
| `suffrage_stamp_2018.jpg` | 2018 stamp: 100 years of women's suffrage in Lithuania | R2 A5 | Stamp © Lietuvos paštas, 2018; design J. Dadonas |
| `radvila_the_orphan.jpg` | Portrait of Mikalojus Kristupas Radvila the Orphan, c. 1590–1604 | R2 A6 | Anonymous painter — public domain (Wikimedia Commons) |
| `eu_enlargement_2004_map.png` | Map of the 2004 EU enlargement | R2 A7 | Wikimedia Commons, "EU25-2004 European Union map enlargement.svg" |
| `saltibarsciai.jpg` | Šaltibarščiai | R2 A8 | Food-blog photo (Canon EOS 5D III, Lightroom 2023), source untraced — **to confirm** |
| `metallica_freeze_em_all.jpg` | "Freeze 'Em All" artwork, Antarctica 2013 | R3 A1 | © Metallica / Blackened Recordings (film artwork — fine for an internal quiz, not for publication) |
| `trimates_goodall_fossey_galdikas.jpg` | Galdikas, Goodall and Fossey, 1970s | R3 A2 | Historic photograph, widely reproduced (likely Leakey Foundation archive) — **to confirm** |
